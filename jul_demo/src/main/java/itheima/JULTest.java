...
public class JULTest {
    ...
    public void testLogConfig() throws Exception {
        ...
        //yige  log xia zhidingduoge heander
        ...
        // 场景FileHandler  文件输出
        FileHandler fileHandler = new FileHandler("D:/logs/jul.log"); //winds,linux
...
//        // 通过LogManager加载配置文件
        ...
        // 创建日志记录器
        Logger logger = Logger.getLogger("com.itheima"); //当前类使用的ConsoleHandler
        ...
        Logger logger2 = Logger.getLogger("test"); //test使用的FileHandler
